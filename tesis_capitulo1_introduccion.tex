...
El principal desaf\'io f\'isico en esta nueva era se denomina el \textbf{Muro T\'ermico} (\emph{The Thermal Wall}). Mientras que hist\'oricamente un rack de servidores t\'ipico disipaba entre 4~kW y 10~kW, la adopci\'on de aceleradores modernos de IA (como las plataformas NVIDIA Blackwell) ha elevado el \emph{Thermal Design Power} (TDP) a rangos entre 1.000~W y 1.400~W por chip individual \cite{ashrae2021}.
