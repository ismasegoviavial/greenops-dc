...
El modelo de series de tiempo \texttt{ARIMA\_PLUS} en BigQuery ML gener\'o un pron\'ostico horariode temperatura de $24\text{ horas}$ para el d\'ia $2026-06-21$ (Tabla~\ref{tab:forecast_tesis}).
