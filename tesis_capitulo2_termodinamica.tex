...
\section{M\'etodo $\epsilon$-NTU para Intercambiadores de Calor Bif\'asicos}
El an\'alisis t\'ermico de los condensadores y placas fr\'ias evaporativas se realiza mediante el m\'etodo de \textbf{Efectividad - N\'umero de Unidades de Transferencia ($\epsilon$-NTU)}. La efectividad del intercambiador se define como:
\begin{equation}
